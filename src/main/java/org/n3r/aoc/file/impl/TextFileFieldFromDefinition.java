...
import org.n3r.aoc.file.TextFileFieldValidator;
...
public class TextFileFieldFromDefinition {
    ...
    public static TextFileFieldFromDefinition createField(Properties properties, String fieldName) {
        ...
        if (StringUtils.isNotEmpty(fieldValidators)) {
            ...
            for (String validatorName : validatorsNames) {
                validators.add((TextFileFieldValidator) Aocs.loadObject(properties, validatorName));
            }
        }
    ...
    public Object validate(String fieldStringValue) {
        ...
        for (TextFileFieldValidator validator : validators) {
            validator.validate(convertedValue, fieldStringValue);
        }
