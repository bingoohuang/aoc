...
import org.n3r.aoc.file.TextFileFieldToCreator;
...
public class TextFileFieldToDefinition {
    ...
    public static TextFileFieldToDefinition createField(Properties properties, String fieldName, Map<String, TextFileFieldFromDefinition> fromNameMap) {
        ...
        TextFileFieldToCreator creator = isEmpty(fieldToCreator) ? null
                : (TextFileFieldToCreator) loadObject(properties, fieldToCreator);
